...
"""
# version 7.0.1
# build scrollbar for SystemSolverEntry and for FunctionEntry
"""

class MathPy:
    __author__ = 'Achraf Najmi'
    __version__ = '7.0.1 beta1'
    __name__ = 'MathPy'
    btn_prm = {'padx': 18,
               'pady': 1,
               'bd': 1,
    ...
    def SwitchEntryWidget(self, widget):
        ...
        if figure == 'MultiEntry':
            ...
            self.SSE = SystemSolverEntry(self.win, line=3, height=267, bg='#F0F0F0')
    ...
    def Delete(self):
        ...
        if self.mode == 'Operation':
            ...
            if self.SSE.u == 3:
                ...
                self.SSE.label0[0]['text'] = 'eq₁>'
                self.SSE.label0[1]['text'] = 'eq₂>'
                self.SSE.label0[2]['text'] = 'eq₃>'
        ...
        try:
            ...
            if keyword.keysym == 'BackSpace':
                ...
                self.Input('pi')
                    ...
                    put == '7' or put == '8' or put == '9' or put == '0':
                self.Input(put)
    ...
    def ShowInput(self):
        ...
        if self.mode == 'SystemSolver':
            self.SSE().focus_set()
            self.SSE.on_configure_x()
        elif self.mode == 'PP2D3DL' or self.mode == "P3DPS":
            self.FE().focus_set()
            self.FE.on_configure_x()
        else:
            self.TextDisplay.focus_set()
        ...
        try:
            if self.mode == 'Operation':
                ...
                if self.SSE.u == 3:
                    ...
                    small_numbers = SmallNumbers(how_much_numbers=much_sol, place_of_script='sub')
